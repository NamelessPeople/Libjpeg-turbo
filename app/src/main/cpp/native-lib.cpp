...
//统一编译方式
extern "C" {
#include "../jniLibs/jpeglib.h"
#include "../jniLibs/cdjpeg.h"        /* Common decls for cjpeg/djpeg applications */
#include "../jniLibs/jconfig.h"
#include "../jniLibs/jconfigint.h"
}
#define LOG_TAG "jni"
...
Java_com_github_namelesspeople_libjpegstudy_JpegNative_compressBitmap(JNIEnv *env, jclass type,
                                                                      jobject bitmap, jint quality,
                                                                      jstring fileNameStr,
                                                                      jboolean optimize) {
//    const char *fileNameStr = env->GetStringUTFChars(fileNameStr_, 0);
...
//    env->ReleaseStringUTFChars(fileNameStr_, fileNameStr);
}